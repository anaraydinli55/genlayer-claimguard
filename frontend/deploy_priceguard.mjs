...
async function main() {
  const code = readFileSync("../../genlayer-priceguard/PriceGuard.py", "utf-8");
  console.log("🚀 Deploying PriceGuard...");
  ...
  console.log("🔗 Explorer: https://explorer-studio.genlayer.com/address/" + addr);
}
